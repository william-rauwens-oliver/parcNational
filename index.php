  ...
  <section class="section__container destination__container" id="camping">
    ...
    <div class="destination__grid">
      <?php if (!empty($reservation_camping)): ?>
        <?php foreach ($reservation_camping as $reservation): ?>
          <div class="destination__card">
            <img src="<?php echo htmlspecialchars($reservation['image']); ?>" alt="camping" />
            <div class="destination__card__details">
              <div>
                <h4><?php echo htmlspecialchars($reservation['nom_camping']); ?></h4>
                ...
                <p>Nombre de personnes: <?php echo htmlspecialchars($reservation['nombre_personnes']); ?></p>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
